...
<div class="akeeba-form-group">
	...
	<div class="akeeba-toggle">
		{{ FEFSelect::booleanList('mail_online', ['forToggle' => 1, 'colorBoolean' => 1], $config->get('mail.online', 1)) }}
	</div>
...
<div class="akeeba-form-group">
	...
	<div class="akeeba-toggle">
		{{ FEFSelect::booleanList('mail_smtpauth', array('forToggle' => 1, 'colorBoolean' => 1), $config->get('mail.smtpauth', 1)) }}
	</div>
	<p class="akeeba-help-text">
