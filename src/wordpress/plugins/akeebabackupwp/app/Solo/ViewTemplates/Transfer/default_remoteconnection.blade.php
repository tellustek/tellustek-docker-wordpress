    ...
    <form class="akeeba-form--horizontal">
        <div class="akeeba-transfer-main-container">
            ...
            <div id="akeeba-transfer-row-url" class="akeeba-form-group--pull-right">
                <img src="@media('media://image/loading.gif')" alt="Loading. Please wait..."
        ...
        <div id="akeeba-transfer-ftp-container" style="display: none">
            <div class="akeeba-form-group">
                ...
                {{ \Awf\Html\Select::genericList($this->transferOptions, 'akeeba-transfer-ftp-method', array(), 'value', 'text', $this->transferOption, 'akeeba-transfer-ftp-method') }}
            ...
            <div class="akeeba-form-group" id="akeeba-transfer-ftp-passive-container">
                ...
                <div class="akeeba-toggle">
                    {{ FEFSelect::booleanList('akeeba-transfer-ftp-passive', array('forToggle' => 1, 'colorBoolean' => 1), $this->ftpPassive ? 1 : 0, 'AWF_YES', 'AWF_NO', 'akeeba-transfer-ftp-passive') }}
                </div>
            </div>
            ...
            <div class="akeeba-form-group" id="akeeba-transfer-ftp-passive-fix-container">
                ...
                <div class="akeeba-toggle">
                    {{ FEFSelect::booleanList('akeeba-transfer-ftp-passive-fix', array('forToggle' => 1, 'colorBoolean' => 1), $this->ftpPassive ? 1 : 0, 'AWF_YES', 'AWF_NO', 'akeeba-transfer-ftp-passive-fix') }}
                </div>
                <p class="akeeba-help-text">
            ...
            <div id="akeeba-transfer-apply-loading" class="akeeba-block--info" style="display: none;">
                ...
                <p style="text-align: center;">
                    <img src="@media('media://image/loading.gif')"
