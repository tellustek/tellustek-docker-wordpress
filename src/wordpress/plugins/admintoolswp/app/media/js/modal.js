...
if (typeof admintools.Modal == 'undefined')
{
	/*!
	...
	admintools.Modal = (function ()
	{
		...
		method.show = function (parameters)
		{
			try
			{
				console.log('Using admintools.Modal.show() is deprecated. Use .open() instead.');
			}
			catch (e)
			{
		...
		{
			if ((inheritedElement !== null) && (inheritedElement.length !== 0))
			{
