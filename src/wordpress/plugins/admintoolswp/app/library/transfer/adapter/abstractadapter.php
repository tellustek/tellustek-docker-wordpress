...
abstract class AbstractAdapter implements TransferInterface
{
	/**
	 * Load order priority
	 *
	 ...
	 *
	 * @param   string  $url        The remote URL (containing any GET params)
	 * @param   array   $postdata   Any additional post data to send
	 * @param   array   $params     Additional params that will be added before performing the request
	 *
	 * @return  mixed
	 */
