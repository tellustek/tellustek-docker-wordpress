...
namespace Akeeba\AdminTools\Library\Input;
 ...
 *
 * @package \Akeeba\AdminTools\Library\Input
 */
class Filter
{
	/**
	 * @var    array  A container for \Akeeba\AdminTools\Library\Input\Filter instances.
	 */
	...
	public static function &getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1)
	{
		...
		{
			self::$instances[$sig] = new Filter($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
		}
	...
	protected function _decode($source)
	{
		...
		// Convert decimal
		$source = preg_replace_callback('/&#(\d+);/m', [self::class, 'utf8_encode'], $source);  // decimal notation
