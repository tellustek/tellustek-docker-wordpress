...
<h1>
	...
	<?php echo Language::_('COM_ADMINTOOLS_TITLE_IPBL_EDIT');?>
</h1>
...
<section class="akeeba-panel">
    ...
    <form action="<?php echo ADMINTOOLSWP_URL; ?>&view=BlacklistedAddresses" method="post" class="akeeba-form--horizontal">
