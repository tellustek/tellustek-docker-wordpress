...
<div>
    <h1>
        ...
        <?php echo Language::_('COM_ADMINTOOLS').'</a>'.Language::_('COM_ADMINTOOLS_TITLE_HTMAKER'); ?>
    </h1>

    <form name="adminForm" id="adminForm" action="<?php echo ADMINTOOLSWP_URL; ?>&view=HtaccessMaker" method="post" class="akeeba-form">
        <div class="akeeba-block--info">
            <p>
                <strong>
                    <?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_WILLTHISWORK'); ?>
                </strong>
            </p>
            <p>
                <?php if ($this->isSupported == 0): ?>
                    <?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_WILLTHISWORK_NO'); ?>
                <?php elseif ($this->isSupported == 1): ?>
                    <?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_WILLTHISWORK_YES'); ?>
                <?php else: ?>
                    <?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_WILLTHISWORK_MAYBE'); ?>
                <?php endif; ?>
            </p>
        </div>

        <div class="akeeba-block--warning">
            <h3><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_WARNING'); ?></h3>

            <p><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_WARNTEXT'); ?></p>

            <p><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_TUNETEXT'); ?></p>
        </div>
        ...
        <div class="akeeba-panel--primary">
            ...
            <div class="akeeba-form-section--horizontal">
                ...
                <div class="akeeba-form-group">
                    <label for="staticrisks"><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_STATICRISKS') ?></label>

                    <div>
	                    <?php echo SelectHelper::booleanswitch('staticrisks', $config->staticrisks); ?>
                    </div>
                </div>
        ...
        <div class="akeeba-panel--primary">
            <header class="akeeba-block-header">
                <h3><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_CUSTOM'); ?></h3>
            </header>

            <div class="akeeba-form-section--horizontal">
                <div class="akeeba-form-group">
                    <label for=""><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_CUSTHEAD'); ?></label>
                    <div>
                ...
                <div class="akeeba-form-group">
                    <label for=""><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_CUSTFOOT'); ?></label>
                    <div>
        ...
        <div class="akeeba-panel--primary">
            ...
            <div class="akeeba-form-section--horizontal">
                ...
                <div class="akeeba-form-group">
                    <label for=""><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_FORCEGZIP'); ?></label>
                    <div>
						<?php echo SelectHelper::booleanswitch('forcegzip', $config->forcegzip); ?>
                    </div>
                </div>
                ...
                <div class="akeeba-form-group">
                    <label for=""><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_UTF8CHARSET'); ?></label>
                    <div>
						<?php echo SelectHelper::booleanswitch('utf8charset', $config->utf8charset); ?>
                    </div>
                </div>
        ...
        <div class="akeeba-panel--primary">
            ...
            <div class="akeeba-form-section--horizontal">
                ...
                <div class="akeeba-form-group">
                    <label for=""><?php echo Language::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_SYMLINKS'); ?></label>
                    <div>
